var SnekDirection;
(function (SnekDirection) {
    SnekDirection[SnekDirection["Invalid"] = 0] = "Invalid";
    SnekDirection[SnekDirection["Up"] = 1] = "Up";
    SnekDirection[SnekDirection["Left"] = 2] = "Left";
    SnekDirection[SnekDirection["Down"] = 3] = "Down";
    SnekDirection[SnekDirection["Right"] = 4] = "Right";
})(SnekDirection || (SnekDirection = {}));
let map;
class SnekMap {
    constructor() {
        this.size = 24;
        this.fieldSize = 600 / 24;
        this.scoreAmount = 0;
        this.snek = [];
    ...
    move() {
        ...
        if (tail.x < 0) {
            tail.x = self.fieldSize - 1;
        }
        if (tail.y < 0) {
            tail.y = self.fieldSize - 1;
        }
        if (tail.x > self.fieldSize - 1) {
            tail.x = 0;
        }
        if (tail.y > self.fieldSize - 1) {
            tail.y = 0;
        }
